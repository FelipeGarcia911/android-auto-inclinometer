...
private val GRColorScheme = darkColorScheme(
    ...
    onBackground = InstrumentText,
    surface = InstrumentSurface,
    onSurface = InstrumentText,
    surfaceVariant = InstrumentSurfaceElevated,
    onSurfaceVariant = InstrumentMutedText,
    outline = InstrumentBorder,
